...
public class DrawingController implements MouseListener, MouseMotionListener, ComponentListener, KeyListener {
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        switch (drawingStateController.getState()) {
            // Este es el codigo que maneja la creacion de una primitiva
            // al hacer clic en la pantalla y arrastrar el mouse
            case DrawingStateController.IDLE:
                if (selectedGraphicPrimitive != null) {
                    setSelectedGraphicPrimitive(null);
                }
            ...
            // Este es el codigo que maneja la modificacion de un punto
            // de control
            case DrawingStateController.TRANSFORMING:
                if (gp != null) {
                ...
                break;
            // Este codigo maneja las traslaciones de las primitivas
            case DrawingStateController.MOVING:
                HandlePoint tempHP = new HandlePoint(null, e.getX(), e.getY());
            ...
            // Este es el codigo que maneja la rotacion de una primitiva
            case DrawingStateController.ROTATING:
                HandlePoint temporalHP = new HandlePoint(null, e.getX(), e.getY());
//                temporalHP.substractHandlePoint(lastMousePosition);
...
//                System.out.println("Angle: " + angle);
                ...
                // Vemos si tenemos que rotar hacia un lado o hacia el otro
...
//                canvas.getImageController().removeGraphicPrimitive(selectedGraphicPrimitive);
//                canvas.getImageController().getGraphicPrimitives().add(selectedGraphicPrimitive);
...
//        drawingStateController.setState(state);
        switch (state) {
            case DrawingStateController.IDLE:
...
//        System.out.println("DRAWING CONTROLLER: " + stateName);
    ...
    /** Devuelve el punto de control correspondiente a la coordenada x, y.
