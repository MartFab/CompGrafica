...
public class SimplePrimitiveDrawer implements PrimitiveDrawer {
    ...
    public void drawCircle(Circle circle) {
        ...
        int[] c = new int[]{circle.getBorderColor().getRed(),
        ...
        int stoppingX;
        int stoppingY;
        int xRadius = (int) circle.getControlPoint().getX();
        int yRadius = (int) circle.getControlPoint().getX();
        ...
        if ((xRadius != 0) && (yRadius != 0) ) {
            ...
            while (stoppingX >= stoppingY) {
                ...
                paintPixel((int) circle.getStartPoint().getX() + x, (int) circle.getStartPoint().getY() + y, c);
                paintPixel((int) circle.getStartPoint().getX() - x, (int) circle.getStartPoint().getY() + y, c);
                paintPixel((int) circle.getStartPoint().getX() - x, (int) circle.getStartPoint().getY() - y, c);
                paintPixel((int) circle.getStartPoint().getX() + x, (int) circle.getStartPoint().getY() - y, c);
                y++;
    ...
    public void draw(GraphicPrimitive gp) {
        if (gp instanceof Point) {
            ...
            drawArc((Arc) gp);
        } else if (gp instanceof Circle) {
            drawCircle((Circle) gp);
        } else {
